...
(function ($) {
    ...
    var Notification = function Notification(container, options) {
...
(function ($) {
    ...
    var Card = function Card(element, options) {
        this.$element = $(element);
...
(function ($) {
    ...
    var MobileView = function MobileView(element, options) {
        var self = this;
    ...
    $.fn.pgMobileViews.defaults = {
        ...
        onNavigate: function onNavigate(view, animation) {}
...
(function ($) {
    ...
    var Quickview = function Quickview(element, options) {
        this.$element = $(element);
